...
<body>
    ...
    <script>
        function check_validate() {
            ...
            if (array_input[0].value != "" && array_input[1].value != "" && array_input[2].value == array_input[1].value) {
                return true;
            }
            ...
            if (array_input[2].value == '') {
                array_span[2].innerText = 'bạn chưa nhập lại pass'
                array_span[2].style.color = 'red';
                array_span[2].style.fontSize = '20px';
            } else if (array_input[2].value == array_input[1].value) {
                array_span[2].innerText = '';
            } else {
                array_span[2].innerText = 'vui lòng nhập đúng pass bạn vừa nhập '
                array_span[2].style.color = 'red';
                array_span[2].style.fontSize = '20px';
            }
            return false;
